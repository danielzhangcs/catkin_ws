...
"""autogenerated by genpy from prrexamples/TimerActionResult.msg. Do not edit."""
import codecs
import sys
...
class TimerActionResult(genpy.Message):
  ...
  _type = "prrexamples/TimerActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','prrexamples/TimerResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = prrexamples.msg.TimerResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = prrexamples.msg.TimerResult()
