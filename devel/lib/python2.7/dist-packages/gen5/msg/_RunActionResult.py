...
"""autogenerated by genpy from gen5/RunActionResult.msg. Do not edit."""
import codecs
import sys
...
class RunActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "gen5/RunActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','gen5/RunResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RunActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = gen5.msg.RunResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = gen5.msg.RunResult()
