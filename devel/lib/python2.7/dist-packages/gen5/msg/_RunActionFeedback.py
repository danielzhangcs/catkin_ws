...
"""autogenerated by genpy from gen5/RunActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class RunActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "gen5/RunActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','gen5/RunFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RunActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = gen5.msg.RunFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = gen5.msg.RunFeedback()
