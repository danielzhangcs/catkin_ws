...
"""autogenerated by genpy from gen5/RunAction.msg. Do not edit."""
import codecs
import sys
...
class RunAction(genpy.Message):
  _md5sum = "42d70adb3c934f22ba3ca8c963682e93"
  _type = "gen5/RunAction"
...
"""
  ...
  _slot_types = ['gen5/RunActionGoal','gen5/RunActionResult','gen5/RunActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RunAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = gen5.msg.RunActionGoal()
      if self.action_result is None:
        self.action_result = gen5.msg.RunActionResult()
      if self.action_feedback is None:
        self.action_feedback = gen5.msg.RunActionFeedback()
    else:
      self.action_goal = gen5.msg.RunActionGoal()
      self.action_result = gen5.msg.RunActionResult()
      self.action_feedback = gen5.msg.RunActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2f3I().pack(_x.action_goal.goal.distance, _x.action_goal.goal.linear_velocity, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.distance, _x.action_goal.goal.linear_velocity, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_2f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
