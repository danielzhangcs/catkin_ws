...
"""autogenerated by genpy from gen5/RotateActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class RotateActionFeedback(genpy.Message):
  ...
  _type = "gen5/RotateActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','gen5/RotateFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = gen5.msg.RotateFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = gen5.msg.RotateFeedback()
