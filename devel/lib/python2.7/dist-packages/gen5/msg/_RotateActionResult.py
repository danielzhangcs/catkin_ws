...
"""autogenerated by genpy from gen5/RotateActionResult.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','gen5/RotateResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = gen5.msg.RotateResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = gen5.msg.RotateResult()
