...
"""autogenerated by genpy from robot_services/RotateActionResult.msg. Do not edit."""
import codecs
import sys
...
class RotateActionResult(genpy.Message):
  _md5sum = "c77370f28cdda6dc3cef03fbf32f4697"
  _type = "robot_services/RotateActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_services/RotateResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RotateActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = robot_services.msg.RotateResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robot_services.msg.RotateResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.time_taken,) = _get_struct_f().unpack(str[start:end])
      return self
