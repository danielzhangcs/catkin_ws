...
(cl:defclass <MotorStatusLR> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (left
    :reader left
    :initarg :left
    :type mygopigo-msg:MotorStatus
    :initform (cl:make-instance 'mygopigo-msg:MotorStatus))
   (right
    :reader right
    :initarg :right
    :type mygopigo-msg:MotorStatus
...
(cl:defmethod cl:initialize-instance :after ((m <MotorStatusLR>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorStatusLR)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mygopigo-msg:<MotorStatusLR> is deprecated: use mygopigo-msg:MotorStatusLR instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <MotorStatusLR>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mygopigo-msg:header-val is deprecated.  Use mygopigo-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'left-val :lambda-list '(m))
(cl:defmethod left-val ((m <MotorStatusLR>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mygopigo-msg:left-val is deprecated.  Use mygopigo-msg:left instead.")
  (left m))

(cl:ensure-generic-function 'right-val :lambda-list '(m))
(cl:defmethod right-val ((m <MotorStatusLR>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mygopigo-msg:right-val is deprecated.  Use mygopigo-msg:right instead.")
  (right m))
