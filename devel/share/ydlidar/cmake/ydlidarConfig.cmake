...
if("TRUE" STREQUAL "TRUE")
  set(ydlidar_SOURCE_PREFIX /my_ros_data/catkin_ws/src/Hands-On-ROS-for-Robotics-Programming/Chapter9_GoPiGo3_SLAM/ydlidar)
  set(ydlidar_DEVEL_PREFIX /my_ros_data/catkin_ws/devel)
  set(ydlidar_INSTALL_PREFIX "")
  set(ydlidar_PREFIX ${ydlidar_DEVEL_PREFIX})
else()
  set(ydlidar_SOURCE_PREFIX "")
  set(ydlidar_DEVEL_PREFIX "")
  set(ydlidar_INSTALL_PREFIX /my_ros_data/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ydlidar' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/my_ros_data/catkin_ws/src/Hands-On-ROS-for-Robotics-Programming/Chapter9_GoPiGo3_SLAM/ydlidar/${idir}'.  ${_report}")
    endif()
