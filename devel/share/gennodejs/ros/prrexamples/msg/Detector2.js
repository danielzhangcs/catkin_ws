...
class Detector2 {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('norm_bearing')) {
        this.norm_bearing = initObj.norm_bearing
      }
      else {
        this.norm_bearing = 0.0;
      }
      if (initObj.hasOwnProperty('norm_dist')) {
        this.norm_dist = initObj.norm_dist
      }
      else {
        this.norm_dist = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [norm_bearing]
    bufferOffset = _serializer.float32(obj.norm_bearing, buffer, bufferOffset);
    // Serialize message field [norm_dist]
    bufferOffset = _serializer.float32(obj.norm_dist, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [norm_bearing]
    data.norm_bearing = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [norm_dist]
    data.norm_dist = _deserializer.float32(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Detector2(null);
    ...
    if (msg.norm_bearing !== undefined) {
      resolved.norm_bearing = msg.norm_bearing;
    }
    else {
      resolved.norm_bearing = 0.0
    }

    if (msg.norm_dist !== undefined) {
      resolved.norm_dist = msg.norm_dist;
    }
    else {
      resolved.norm_dist = 0.0
    }
