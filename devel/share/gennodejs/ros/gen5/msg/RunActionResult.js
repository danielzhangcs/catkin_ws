...
let RunResult = require('./RunResult.js');
...
class RunActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RunResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RunActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = RunResult.Resolve(msg.result)
    }
    else {
      resolved.result = new RunResult()
    }
...
module.exports = RunActionResult;
