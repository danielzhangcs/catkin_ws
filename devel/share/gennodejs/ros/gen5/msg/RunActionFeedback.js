...
let RunFeedback = require('./RunFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class RunActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RunFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RunActionFeedback(null);
    ...
    data.feedback = RunFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RunActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = RunFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new RunFeedback()
    }
...
module.exports = RunActionFeedback;
