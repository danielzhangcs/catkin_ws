...
let RunGoal = require('./RunGoal.js');
...
class RunActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RunGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RunActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = RunGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new RunGoal()
    }
